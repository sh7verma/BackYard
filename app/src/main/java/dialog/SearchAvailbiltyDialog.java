...
public class SearchAvailbiltyDialog implements View.OnClickListener {
    ...
    private void initUI() {
        ...
        if (path == 1) {
            /// availbilty modes
            tvOption1.setText("Only Weekends");
            tvOption2.setText("Weekdays");
            tvOption3.setText("Both");
        } else {
            /// pickup modes
            tvOption1.setText("Deliver at your Location");
            tvOption2.setText("Pickup");
            tvOption3.setText("Both");
        }

        if (mText.equals(tvOption1.getText())) {
