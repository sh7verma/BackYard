        ...
        if ((new Connection_Detector(mContext)).isConnectingToInternet()) {
            ...
            call.enqueue(new Callback<DemoModel>() {
                ...
                public void onResponse(Call<DemoModel> call, Response<DemoModel> response) {
                    ...
                    if (response != null) {
                        Toast.makeText(mContext, "Verification Mail has been sent", Toast.LENGTH_SHORT).show();
                        mDialog.dismiss();
                    } else {
                        ...
                        btCancel.setBackground(mContext.getResources().getDrawable(R.drawable.gradient_base));
                    }
                }
