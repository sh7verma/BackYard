...
public class HistoryHelpFragment extends Fragment implements View.OnClickListener {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        mContentArrayList.add("In case of any queries/disputes, you can contact at  info@yourbackyardapp.com.");
        mContentArrayList.add("For more information, please visit our website at http://yourbackyardapp.com");
