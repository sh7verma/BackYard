...
public class ListedTulsFragment extends Fragment implements View.OnClickListener {
    ...
    ArrayList<ProfileModel.ResponseBean.ProductBean> mTulsArray = new ArrayList<>();
    Db db;
    ...
    public void setServerData(List<ProfileModel.ResponseBean.ProductBean> tulsArray) {
        if (tulsArray.size() > 0) {
            mTulsArray.clear();
