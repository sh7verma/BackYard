...
import com.app.backyard.BlockedUsersActivity;
...
public class BlockedUsersAdapter extends RecyclerView.Adapter<BlockedUsersAdapter.ViewHolder> {
    ...
    void unBlockDialog(final String finalParticpantId, final ChatDialogModel chatDialogModel) {
        ...
        alertDialog.setPositiveButton(con.getString(R.string.unblock), new DialogInterface.OnClickListener() {
        ...
        alertDialog.setNegativeButton(con.getString(R.string.cancel), new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                dialog.cancel();
            }
        });
