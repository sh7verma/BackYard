...
import com.app.backyard.TulAccountDetailActivity;
...
public class PaymentAccountsAdapter extends RecyclerView.Adapter<PaymentAccountsAdapter.ViewHolder> {
    ...
    ArrayList<CreateStripeAccountModel.ResponseBean> mAccountArrayList = new ArrayList<>();
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        String earning = "0";
        if (!TextUtils.isEmpty(mAccountArrayList.get(position).getEarning())) {
            earning = mAccountArrayList.get(position).getEarning();
        }
        holder.tvEarningCount.setText(mAccountArrayList.get(position).getCurrency()+ earning);
