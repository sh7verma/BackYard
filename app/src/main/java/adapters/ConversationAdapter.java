        ...
        holder.llMain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if ((new Connection_Detector(con)).isConnectingToInternet()) {
                    ...
                    Toast.makeText(con, R.string.Internet_connection_not_available, Toast.LENGTH_SHORT).show();
                }
...
//                inChat.putExtra("name", mConversationMap.get(mConversationKeys.get(position)).getName().get(mOtherUserId));
//
//                inChat.putExtra("other_block_status", mConversationMap.get(mConversationKeys.get(position)).getBlock_status().get(mOtherUserId));
...
////                }
    ...
    private void isChatDisabled(final int position, final String otherUserId) {
