...
public class TulReviewRatingsActivity extends BaseActivity {
    ...
    protected void onCreateStuff() {
        ...
        if (connectedToInternet()) {
            ...
            txtNotTuls.setText(R.string.NO_INTERNET_CONNECTION);
        }
    ...
    private void hitAPI() {
        Call<ReviewRatingModel> call = RetrofitClient.getInstance().reviewsRatings(utils.getString("access_token", ""), getIntent().getIntExtra("tool_id", 0));
    ...
    void setData(ArrayList<ReviewRatingModel.ResponseBean> mReviewArray, int avgRating, int count) {
        ...
        if (mReviewArray.size() > 0) {
            ...
            txtNotTuls.setVisibility(View.VISIBLE);
            txtNotTuls.setText(R.string.NO_REVIEWS_YET);
        }
