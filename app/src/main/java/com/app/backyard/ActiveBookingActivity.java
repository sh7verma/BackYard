...
public class ActiveBookingActivity extends BaseActivity implements UpdateDataListener {
    ...
    protected void initUI() {
        ...
        mBookingArray = new ArrayList<>();
        mLentArray = new ArrayList<>();

        txtToolbarTitle.setTextSize(TypedValue.COMPLEX_UNIT_PX, (float) (mWidth * 0.045));
        txtToolbarTitle.setText(getResources().getString(R.string.active_bookings));
    ...
    protected void onCreateStuff() {
        ...
        if (connectedToInternet()) {
            ...
            showAlert(rlBooking, errorInternet);
        }
    }
    ...
    private void addMyBookingsToLocal(List<BookTulModel.ResponseBean> response) {
        ...
        for (BookTulModel.ResponseBean responseBean : response) {
            db.addMyBooking(responseBean, this);
    ...
    public void cancelTulBooking(final String tool_id, final String booking_id, final int position) {
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setMessage(R.string.Cancellation_charges_will_be_deducted_from_booking_amount_Do_you_want_to_proceed)
                .setCancelable(false)
    ...
    public void cancelTulLent(final String tool_id, final String booking_id, final int position) {
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setMessage(R.string.By_cancelling_your_overall_ratings_will_be_reduced_and_this_will_affect_your_future_bookings_Do_you_want_to_proceed)
                .setCancelable(false)
                .setPositiveButton(R.string.confrim, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        Intent intent = new Intent(mContext, SignatureActivity.class);
    ...
    public void handOverTul(final String tool_id, final String booking_id, final int position) {
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setMessage(R.string.Are_you_sure_you_want_to_mark_this_BACK_YARD_as_Checked_In)
                .setCancelable(false)
                .setPositiveButton(R.string.confrim, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        Intent intent = new Intent(mContext, SignatureActivity.class);
    ...
    public void returnTul(final String tool_id, final String booking_id, final int position,
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setMessage(R.string.Are_you_sure_you_want_to_mark_this_Place_as_Checked_out)
                .setCancelable(false)
                .setPositiveButton(R.string.confrim, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        Intent intent = new Intent(mContext, SignatureActivity.class);
    ...
    public void lenderReceivedTul(final String tool_id, final String booking_id, final int position,
                                  final String owner, final String owner_pic, final String total_amount, final String address, final BookTulModel.ResponseBean responseBean,
                                  final int user_id, final int borrower_id, final String borrower, final String borrower_pic) {
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setMessage(R.string.Are_you_sure_you_want_to_mark_this_BACK_YARD_as_Check_out)
                .setCancelable(false)
                .setPositiveButton(R.string.confrim, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        Intent intent = new Intent(mContext, SignatureActivity.class);
        ...
        public void onReceive(Context context, Intent intent) {
            try {
                if (intent.getStringExtra("push_type").equals("1")) {
                    ///lender marked as checkout push on user side.
                    db.updateBorrowerStatusByPush(Integer.parseInt(intent.getStringExtra("booking_id")), "2", intent.getStringExtra("date"));
                } else if (intent.getStringExtra("push_type").equals("2")) {
                    /// user marked as checked out push on lender side
                    db.updateLentStatusByPush(Integer.parseInt(intent.getStringExtra("booking_id")), "2", intent.getStringExtra("date"));
                    ...
                    db.updateBorrowerStatusByPush(Integer.parseInt(intent.getStringExtra("booking_id")), "2", intent.getStringExtra("date"));
                } else if (intent.getStringExtra("push_type").equals("6")) {
                ...
                } else if (intent.getStringExtra("push_type").equals("11")) {
