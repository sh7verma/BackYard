...
public class EditVerifyPhoneNumber extends Activity implements View.OnClickListener {
...
// ---retrieve the SMS message received---
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContext = EditVerifyPhoneNumber.this;
...
//        Toast.makeText(mContext, "The OTP is 1111 for now", Toast.LENGTH_LONG).show();
        initUI();
        initListener();
        setData();
        disabledViews();
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (edCode1.getText().toString().length() == 1) {
                    ...
                    if (edCode1.getText().toString().length() > 0) {
                        ...
                        imgVerifyStatus.setImageResource(R.mipmap.ic_enter_code);
                    }
                }
            }
    ...
    private void checkOTP() {
        if ((new Connection_Detector(mContext)).isConnectingToInternet()) {
            ...
            if (String.valueOf(util.getInt("otp", 0)).equals(mStringBuilder.toString())) {
                ...
                imgVerifyStatus.setImageResource(R.mipmap.ic_verified);
...
//                Toast.makeText(mContext, "Work in Progress", Toast.LENGTH_SHORT).show();
    ...
    private void hitResendAPI() {
        ...
        Call<SignupModel> call = RetrofitClient.getInstance().callEditResend(util.getString("access_token", ""),
        ...
        call.enqueue(new Callback<SignupModel>() {
            ...
            public void onResponse(Call<SignupModel> call, Response<SignupModel> response) {
                if (response.body().getResponse() != null) {
                    ...
                    startTimer();
                    disableButtons();
                    Toast.makeText(mContext, R.string.OTP_Successfully_sent, Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void hitCallAPI() {
        ...
        Call<SignupModel> call = RetrofitClient.getInstance().callEditUser(util.getString("access_token", ""),
                getIntent().getStringExtra("code"),
                getIntent().getStringExtra("phone"));
    ...
    private void hitAPI() {
        CustomLoadingDialog.getLoader().showLoader(mContext);
        Call<SignupModel> call = RetrofitClient.getInstance().userEditVerify(util.getString("access_token", ""),
