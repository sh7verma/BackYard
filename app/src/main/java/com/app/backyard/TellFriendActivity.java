...
public class TellFriendActivity extends BaseActivity {
    ...
    protected void initUI() {
        ...
        txtToolbarTitle.setText(R.string.TELL_A_FRIEND);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.ll_facebook:
                if (ShareDialog.canShow(ShareLinkContent.class)) {
                    ShareLinkContent linkContent = new ShareLinkContent.Builder()
                            .setContentTitle("BACKYARD")
                            .setContentDescription(getResources().getString(R.string.share_content))
                            .setContentUrl(Uri.parse("www.yourbackyardapp.com"))
                            .setImageUrl(Uri.parse("https://www.applify.co/images/artist-image.png")).build();
            ...
            case R.id.ll_email:
                ...
                intent.putExtra(Intent.EXTRA_SUBJECT, "BACKYARD APP");
    ...
    private void shareWhatsapp() {
        ...
        try {
            ...
            String imagepath = path + "/Backyard/share.png";
            ...
            if (resolved) {
                ...
                Toast.makeText(mContext, R.string.WhatsApp_is_not_installed, Toast.LENGTH_SHORT).show();
            }
