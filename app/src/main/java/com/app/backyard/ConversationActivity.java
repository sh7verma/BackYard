...
public class ConversationActivity extends BaseActivity implements ChatListener {
    ...
    protected void initUI() {
        ...
        txtToolbarTitle.setText(R.string.inbox);
    ...
    private void setData() {
        ...
        for (String chatDialogId : totalConversationMap.keySet()) {
            ...
            if (android.text.TextUtils.isEmpty(chatDialogModel.getLast_message()) || chatDialogModel.getLast_message().equals(Constants.CHAT_REGEX)) {
    ...
    public void onChildChanged(ChatDialogModel chatDialogModel) {
        ...
        for (String chatDialogId : totalConversationMap.keySet()) {
            ...
            if (android.text.TextUtils.isEmpty(chatDialog.getLast_message()) || chatDialog.getLast_message().equals(Constants.CHAT_REGEX)) {

            } else {
                if (chatDialog.getDelete_outer_dialog().get(utils.getString("user_id", "")).equals("0")) {
    ...
    public void deleteConversation(final String chat_dialog_id) {
        ...
        builder.setMessage(R.string.Are_you_sure_you_want_to_clear_this_chat)
                .setCancelable(false)
