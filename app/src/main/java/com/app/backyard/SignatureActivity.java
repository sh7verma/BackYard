...
public class SignatureActivity extends BaseActivity {
    ...
    protected void initUI() {
        ...
        tvTitle.setText(R.string.SIGNATURE);

        txt_toolbar_clear.setVisibility(View.VISIBLE);
        txt_toolbar_clear.setTextSize(TypedValue.COMPLEX_UNIT_PX, (float) (mWidth * 0.04));
        txt_toolbar_clear.setText(getString(R.string.clear));
        txt_toolbar_clear.setPadding(0, 0, mWidth / 32, 0);
    ...
    protected void onCreateStuff() {
        ...
        if (mPath.equals("1"))
            tvSignDetail.setText(getString(R.string.I_hereby_declare_that_I_am_cancelling_Place) + mTulDataModel.getTitle() + getString(R.string._booking));
        else if (mPath.equals("4"))/// borrower marking this return
            tvSignDetail.setText(R.string.I_hereby_declare_that_I_am_checking_out_from_the_Place);
        else if (mPath.equals("5"))/// lender marking this  user has cehcked out
            tvSignDetail.setText(R.string.I_hereby_declare_that_the_user_has_checked_out_from_the_Place);
    ...
    protected void initListener() {
        ...
        txt_toolbar_clear.setOnClickListener(this);
    }
    ...
    private void hitLenderReceivedAPI(File file) {
        ...
        call.enqueue(new Callback<DemoModel>() {
            ...
            public void onResponse(Call<DemoModel> call, Response<DemoModel> response) {
                hideProgress();
                Log.d("RESSIGNATURE", String.valueOf(response.body()));
...
//                          response.body().response.getDate(), "2");
                    /// deleteing from active booking booking table.

                    db.deleteBooking(Integer.parseInt(getIntent().getStringExtra("booking_id")), getIntent().getStringExtra("tool_id"));
                    /// adding value in history booking table
    ...
    private void onDoneClicked() {
        if (isSigned) {
            ...
            if (bitmap != null) {
                ...
                showAlert(llMain, getString(R.string.Please_Sign_above));
            }
        } else
            showAlert(llMain, getString(R.string.Please_Sign_above));
    }
