        ...
        call.enqueue(new Callback<SignupModel>() {
            ...
            public void onResponse(Call<SignupModel> call, Response<SignupModel> response) {
                if (response.body().getResponse() != null) {
                    ...
                    startTimer();
                    disableButtons();
                    Toast.makeText(VerifyPhoneActivity.this, R.string.OTP_Successfully_sent, Toast.LENGTH_SHORT).show();
                } else {
...
//                    finish();
//                } else {
                Intent inStarted = new Intent(mContext, UserTourActivity.class);
