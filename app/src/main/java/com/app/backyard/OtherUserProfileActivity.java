...
//                .placeholder(R.mipmap.ic_image_uploading)
//                .into(imgProfile);
        if (!TextUtils.isEmpty(getIntent().getStringExtra("other_user_pic")))
            Picasso.with(mContext).load(getIntent().getStringExtra("other_user_pic"))
                    .resize(mHeight / 3, mHeight / 3).centerCrop()
                    .placeholder(R.mipmap.ic_image_uploading)
                    .into(imgProfile);
        else
            Picasso.with(mContext).load(R.mipmap.ic_image_uploading).resize(mHeight / 3, mHeight / 3).centerCrop()
                    .into(imgProfile);
